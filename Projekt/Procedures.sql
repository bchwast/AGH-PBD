USE [u_lacki]
GO
/****** Object:  StoredProcedure [dbo].[AddCategory]    Script Date: 18.01.2022 22:07:38 ******/
SET ANSI_NULLS ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddCity]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddDiscount]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddDish]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddDishToMenu]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddDishToOrder]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddFirmCustomer]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AddFirmCustomer]
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddFirmEmployee]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AddFirmEmployee]
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddIndividualCustomer]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddOrder]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddPaymentType]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddReservationForFirm]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AddReservationForFirm]
	@FirmID int,
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddReservationForFirmAnonymous]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AddReservationForFirmAnonymous]
	@FirmID int,
	@ReservationID int,
	@PeopleCount int
AS 
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddReservationForFirmEmployee]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AddReservationForFirmEmployee]
	@FirmID int,
	@PeopleCount int,
	@Phone nchar(9),
	@ReservationID int
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddReservationForIndividual]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddRestaurantEmployee]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AddRestaurantEmployee]
	@FirstName varchar(50),
	@LastName varchar(50),
	@ManagerID int = null,
	@Phone nchar(9),
...
END
GO
/****** Object:  StoredProcedure [dbo].[AddTable]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
    ...
    BEGIN CATCH
		...
		DECLARE @errorMsg nvarchar(2048)='Cannot add new Table. Error message: '
		+ERROR_MESSAGE();
		THROW 52000, @errorMsg,1;
    END CATCH
END
GO
/****** Object:  StoredProcedure [dbo].[AddValueForDiscount]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[AddValueForDiscount]
	@DiscountID int,
	@Type varchar(50),
	@Value int
AS 
...
END
GO
/****** Object:  StoredProcedure [dbo].[ChangeMenu]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[ChangeMenu]
AS 
BEGIN
	BEGIN TRY
	DECLARE @InMenu int
...
END
GO
/****** Object:  StoredProcedure [dbo].[ChangeUnitsInStockValueForDish]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

CREATE PROCEDURE [dbo].[ChangeUnitsInStockValueForDish]
	@DishName varchar(50),
	@UnitsInStock int
AS 
BEGIN
...
END
GO
/****** Object:  StoredProcedure [dbo].[CheckMenu]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
BEGIN
	...
	(
		...
		INNER JOIN [Categories] AS C ON D.[CategoryID] = C.[CategoryID]
		WHERE [OutMenuDate] IS NULL AND C.[CategoryName] != 'Owoce morza' 
		AND DATEDIFF(DAY, GETDATE(), [InMenuDate]) < 14
	)
	IF 2 * @Valid > @InMenu
	BEGIN
		;THROW 52000, 'More than half of dishes in menu have been there for longer than two weeks', 1
	END
	END TRY
	BEGIN CATCH
	DECLARE @errorMsg nvarchar(2048) = 'Menu is invalid. Error message: '
	+ERROR_MESSAGE();
	THROW 52000, @errorMsg,1;
	END CATCH
END
GO
/****** Object:  StoredProcedure [dbo].[ConfirmReservation]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[RemoveDishFromMenu]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[RemoveDishFromMenu]
	@DishName varchar(50)
AS 
BEGIN
	BEGIN TRY 
...
END
GO
/****** Object:  StoredProcedure [dbo].[UpdateCategory]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[UpdateDish]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[UpdateReservationRequirements]    Script Date: 18.01.2022 22:07:39 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[UpdateReservationRequirements]
	@WZValue int,
	@WKValue int
AS 
BEGIN
